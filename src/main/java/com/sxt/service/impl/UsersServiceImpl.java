...
public class UsersServiceImpl implements UsersService {
    ...
    @Override
    public Integer updUserEmail(String usermail,Integer userid) {
        return usersDao.updUserEmail(usermail,userid);
    }

    @Override
    public Integer updUserPhone(String usertel,Integer userid) {
        return usersDao.updUserPhone(usertel,userid);
    }
